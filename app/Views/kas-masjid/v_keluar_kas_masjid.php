                ...
                <table class='table' id="example1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $value['tanggal']?></td>
                            <td><?= $value['ket']?></td>
                            <td class="text-left">Rp. <?= number_format($value['kas_keluar']) ?></td>
                            <td>
...
<?php foreach ($kas as $key => $value) { ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class='form-group'>
                <label>Jumlah</label>
                <input type='number' min="0" name="kas_keluar" value='<?= $value['kas_keluar']?>' class="form-control" required></input>
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
              <a href="<?= base_url('KasMasjid/HapusDataKasKeluar/'. $value['id_kas_masjid'])?>" class="btn btn-danger">Hapus</a>
            </div>
            <?php echo form_close()?>
          </div>
          <!-- /.modal-content -->
