                ...
                <table class="table table-bordered" id="example2" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $no++?></td>
                            <td>
                                <i class='fas fa-credit-card text-success'></i> <?= $value['nama_rek']?>
                            </td>
                            <td><?= $value['no_rek']?></td>
                            <td><?= $value['atas_nama']?></td>
                            <td>
                                <button class="btn btn-flat btn-sm btn-warning" data-toggle="modal" data-target="#modal-edit<?= $value['id_rek']?>"><i class="fas fa-pencil-alt"></i></button>
                                <button class="btn btn-flat btn-sm btn-danger" data-toggle="modal" data-target="#modal-hapus<?= $value['id_rek']?>"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
